            ...
            <div class="main-body mx-3">
                ...
                <form action="<?= base_url('/user/update'); ?>/<?= user()->id; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='username' id="username" autofocus value='<?= old('username', user()->username); ?>'>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control" name='tgl_lahir' id="tgl_lahir" value='<?= old('tgl_lahir', user()->tgl_lahir); ?>'>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="no_telpon" class="col-sm-2 col-form-label">Phone</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name='no_telpon' id="no_telpon" value='<?= old('no_telpon', user()->no_telpon); ?>'>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="user_image"><?= user()->image ?></label>
                            </div>
